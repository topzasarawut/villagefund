        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../articles">President Management</a></li>
        ...
        <form role="form" action="update.php" method="post">
          <div class="card-body">
            <div class="form-group">
              <label for="subject">รหัสหมู่บ้าน</label>
              <input type="text" disabled class="form-control" id="id_village" name="id_village" placeholder="รหัสหมู่บ้าน" value="<?php echo $row['id_village']; ?>" required>
            </div>
            ...
            <div class="form-group">
              <label for="sub_title">ชื่อ</label>
              <input type="text" class="form-control" id="fname" name="fname" placeholder="ชื่อ" value="<?php echo $row['fname']; ?>" required>
            </div>

            <div class="form-group">
              <label for="sub_title">สกุล</label>
              <input type="text" class="form-control" id="lname" name="lname" placeholder="สกุล" value="<?php echo $row['lname']; ?>" required>
            </div>
