          ...
          <table id="dataTable" class="table table-bordered table-striped">
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <tr>
                ...
                <!-- <td><a href="index.php?mat_id=<?php echo $row['material_id']; ?>"><?php echo $sumdata; ?></a></td> -->
                <td><?php echo $row['username']; ?></td>
                <!-- <td><a href="form-equment.php?mat_id=<?php echo $row['material_id']; ?>&&list=<?php echo $row['list']; ?>&&num=<?php echo $sumdata; ?>" class="btn btn-success">เบิก</a></td> -->
