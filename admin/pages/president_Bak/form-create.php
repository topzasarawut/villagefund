        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../material">President Management</a></li>
        ...
        <form role="form" action="create.php" method="post">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="id" name="id_village" placeholder="รหัสหมู่บ้าน" required>
            </div>

            <div class="form-group">
              <label for="sub_title">คำนำหน้า</label>
              <input type="text" class="form-control" id="prefix" name="prefix" placeholder="คำนำหน้า" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="lname" name="lname" placeholder="สกุล" required>
            </div>
