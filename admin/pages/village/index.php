        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Village Management</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">Village List</h3>
          <a href="form-create.php" class="btn btn-primary float-right ">Add Village +</a href="">
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-striped">
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <tr>
                ...
                <td><?php echo $row['name_village']; ?></td>
