    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php } ?>
          <li class="nav-item">
            <a href="../village" class="nav-link <?php echo $name == 'village' ? 'active': '' ?>">
            <i class="fas fa-id-card"></i>
              <p>รายชื่อหมู่บ้าน กทบ.</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../president" class="nav-link <?php echo $name == 'president' ? 'active': '' ?>">
